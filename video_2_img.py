...
if __name__ == "__main__":
    video_folder = "d:/Apollo Tyres Video/camera2/wetransfer_camera-1-footage-regular-running_2024-02-10_0943/camera 1 footage regular running"  # Replace with the folder containing your video files
    output_folder = "d:/Apollo Tyres Video/camera2/wetransfer_camera-1-footage-regular-running_2024-02-10_0943/camera 1"  # Replace with your desired output folder
    interval_seconds = 5
